let timeout = 0xea60,
  ...
  handler = async (_0x44a1fa, {
      ...
      let _0xf5e749 = await (await fetch('https://raw.githubusercontent.com/Xov445447533/Xov11111/master/src/Aesthetic/venom.json'))['json'](),
          ...
          _0x4e9011 = ('*' + _0x5d60f8['toUpperCase']() + '*\x0a  المده *' + (timeout / 0x3e8)['toFixed'](0x2) + '* ثانيه\x0a  استخدم ' + _0xfa5a72 + 'استسلم للاستسلام\x0a  الجائزه: ' + poin + ' XP\x0a{global.venom}$')['trim']();
